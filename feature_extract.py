...
def parse_args():
  ...
  parser.add_argument('--feature_dir', dest='feature_dir',
                      help='directory to save models', default="h5",
                      type=str)
...
if __name__ == '__main__':
  ...
  elif args.dataset == "real_cityscapes_small":
      args.imdb_name = "real_cityscapes_fs"
      args.imdbval_name = "real_cityscapes_fs"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']
  ...
  dataloader = torch.utils.data.DataLoader(dataset, batch_size=1, sampler=sampler_batch, num_workers=args.num_workers)
  ...
  for epoch in range(1):
    ...
    for step in range(iters_per_epoch):
      ...
      print("Finish extracting feature of image {}".format(step))
